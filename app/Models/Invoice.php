...
#[Fillable(['invoice_number', 'client_id', 'status', 'issue_date', 'due_date', 'subtotal', 'discount_percent', 'tax_percent', 'total', 'notes', 'sent_at', 'paid_at', 'reminders_sent', 'last_reminded_at', 'payment_token', 'stripe_payment_intent_id'])]
