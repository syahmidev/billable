    ...
    <div class="min-h-screen bg-gray-950">
        ...
        <div class="flex min-h-screen">
                ...
                >
                    <div class="flex items-center justify-between border-b border-white/10 px-6 py-5">
                        <div>
                            ...
                            <p class="mt-0.5 truncate text-xs text-gray-500">{{ workspace?.name }}</p>
                        </div>
                        <button
                    ...
                    <div class="border-t border-white/10 px-3 py-4">
                        <div class="flex items-center gap-3 px-3 py-2">
                            <div class="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-violet-500/20 text-xs font-semibold text-violet-400">
                            ...
                            <button class="text-gray-500 transition-colors hover:text-white" @click="logout">
            ...
            <div class="flex min-w-0 flex-1 flex-col">
                <!-- Mobile top bar -->
                <div class="flex items-center gap-4 border-b border-white/10 bg-gray-900 px-4 py-3 md:hidden">
